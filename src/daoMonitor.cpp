...
void DaoDataWidget::ViewRoutine( DaoTuple *tuple )
{
...
void DaoDataWidget::ViewFunction( DaoTuple *tuple )
{
}
void DaoDataWidget::ViewClass( DaoTuple *tuple )
{
	EnableThreeTable( NULL );
...
void DaoDataWidget::ViewObject( DaoTuple *tuple )
{
	EnableOneTable( NULL );
